...
namespace ReyfiBurgerWeb {
    ...
    public partial class VentasDataSet : global::System.Data.DataSet {
        ...
        public partial class VentasDataTable : global::System.Data.TypedTableBase<VentasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public VentasRow AddVentasRow(decimal TotalAPagar, decimal Efectivo, decimal Devuelta, System.DateTime Fecha) {
...
namespace ReyfiBurgerWeb.VentasDataSetTableAdapters {
    ...
    public partial class VentasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Ventas] ([TotalAPagar], [Efectivo], [Devuelta], [Fecha]) VALUE" +
                "S (@TotalAPagar, @Efectivo, @Devuelta, @Fecha)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Ventas] SET [TotalAPagar] = @TotalAPagar, [Efectivo] = @Efectivo, [" +
                "Devuelta] = @Devuelta, [Fecha] = @Fecha WHERE (([VentaId] = @Original_VentaId))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT VentaId, TotalAPagar, Efectivo, Devuelta, Fecha FROM dbo.Ventas";
        ...
        public virtual int Insert(decimal TotalAPagar, decimal Efectivo, decimal Devuelta, System.DateTime Fecha) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((decimal)(TotalAPagar));
            this.Adapter.InsertCommand.Parameters[1].Value = ((decimal)(Efectivo));
            this.Adapter.InsertCommand.Parameters[2].Value = ((decimal)(Devuelta));
        ...
        public virtual int Update(decimal TotalAPagar, decimal Efectivo, decimal Devuelta, System.DateTime Fecha, int Original_VentaId) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((decimal)(TotalAPagar));
            this.Adapter.UpdateCommand.Parameters[1].Value = ((decimal)(Efectivo));
            this.Adapter.UpdateCommand.Parameters[2].Value = ((decimal)(Devuelta));
