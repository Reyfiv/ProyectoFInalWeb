<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cCombos.aspx.cs" Inherits="ReyfiBurgerWeb.Consultas.cCombos" %>
...
<asp:Content ID="Content8" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel" style="background-color: #FF9021">
        <div class="panel-heading" style="font-family: Freestyle Script; font-size: 25px; color: #ffffff">Consulta de Combos</div>
    </div>
    ...
    <div class="form-group">
        <div class="col-md-4">
            ...
            <asp:ListItem>ComboId</asp:ListItem>
        ...
        <asp:GridView ID="DatosGridView" runat="server" class="table table-condensed  table-responsive" CellPadding="6" ForeColor="#333333" GridLines="None">
            ...
            <Columns>
                <asp:HyperLinkField ControlStyle-ForeColor="#FF9021"
                    HeaderText="Opciones"
                    DataNavigateUrlFields="ComboId"
                    DataNavigateUrlFormatString="/Registros/rCombos.aspx?Id={0}"
            ...
            <div class="modal-content">
                <div class="modal-header">
                   ...
                   <div class="modal-body">
                    <%--Viewer--%>
                    <rsweb:ReportViewer ID="CombosReportViewer" runat="server" ProcessingMode="Remote" Width="550px">
