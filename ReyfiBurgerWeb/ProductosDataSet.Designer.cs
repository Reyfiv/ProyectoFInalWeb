...
namespace ReyfiBurgerWeb {
    ...
    public partial class ProductosDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductosDataTable : global::System.Data.TypedTableBase<ProductosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ProductosRow AddProductosRow(string NombreProducto, string TipoProducto, decimal Precio, string Descripcion, System.DateTime Fecha) {
...
namespace ReyfiBurgerWeb.ProductosDataSetTableAdapters {
    ...
    public partial class ProductosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Productos] ([NombreProducto], [TipoProducto], [Precio], [Descr" +
                "ipcion], [Fecha]) VALUES (@NombreProducto, @TipoProducto, @Precio, @Descripcion," +
                " @Fecha)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Productos] SET [NombreProducto] = @NombreProducto, [TipoProducto] =" +
                " @TipoProducto, [Precio] = @Precio, [Descripcion] = @Descripcion, [Fecha] = @Fec" +
                "ha WHERE (([ProductoId] = @Original_ProductoId))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductoId, NombreProducto, TipoProducto, Precio, Descripcion, Fecha FROM " +
                "dbo.Productos";
        ...
        public virtual int Insert(string NombreProducto, string TipoProducto, decimal Precio, string Descripcion, System.DateTime Fecha) {
        ...
        public virtual int Update(string NombreProducto, string TipoProducto, decimal Precio, string Descripcion, System.DateTime Fecha, int Original_ProductoId) {
            if ((NombreProducto == null)) {
